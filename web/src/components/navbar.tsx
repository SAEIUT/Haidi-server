                ...
                <div className="nav-icons flex items-center lg_992:order-2 md:ms-6">
                    {!playBtn && 
                        <ul className="list-none menu-social mb-0">
                            ...
                            <li className="inline">
                                 <Link to="/signup" className="h-8 px-4 text-[12px] tracking-wider inline-flex items-center justify-center font-medium rounded-full bg-red-500 text-white uppercase">Signup</Link>
                            </li>
                        </ul>
                    }
                    {playBtn && 
